  ...
  return (
    <section className='px-[5%] py-6 sm:py-8 md:py-10 lg:py-12'>
          <div className='relative flex justify-center flex-col gap-4 items-center w-full h-[350px] md:h-[375px] lg:h-[400px] 2xl:h-[600px] rounded-xl bg-[linear-gradient(45deg,#090328,#0046cc)] text-white'>
            ...
            <button className='w-[135px] 2xl:w-[260px] h-[40px] 2xl:h-[70px] hover:border-2 active:border-2 hover:border-white active:border-white bg-white hover:bg-transparent active:bg-transparent text-black active:text-white hover:text-white rounded-md transition-all duration-300 ease-linear cursor-pointer'>
              {action}
              {" "}{children}
            </button>
          </div>

    ...
    <header>
      <div>
        ...
        <div className='relative px-[5%] mt-4 flex justify-between items-center'>
            ...
            <ul className='list-none text-sm sm:flex hidden flex-row space-x-2 lg:space-x-8 xl:space-x-10 text-[#4c5c75]'>
                <li className={`text-sm ${location.pathname === '/services'? 'font-semibold' : 'font-normal'} md:text-base`}><Link to="/services">Services</Link></li>
                <li className={`text-sm ${location.pathname === '/casestudy'? 'font-semibold' : 'font-normal'} md:text-base`}><a href="/casestudy">Case study</a></li>
                <li className={`text-sm ${location.pathname === '/solutions'? 'font-semibold' : 'font-normal'} md:text-base`}><a href="/solutions">Solutions</a></li>
                <li className='relative group text-sm md:text-base'>
                    <a href="#">Company</a>
                    <ul className='hidden group-hover:flex shadow-md list-none z-80 absolute top-[110%] left-0 bg-white text-black py-6 flex-col space-y-3 rounded-lg text-lg'>
                        ...
                        <li className='pl-4 pr-24 font-semibold hover:text-base hover:font-normal'><Link to="#">Blogs</Link></li>
                    </ul>
                </li>
            </ul>
            <button className='p-2 md:p-3 lg:p-4 rounded-md text-white bg-[linear-gradient(45deg,#0146cc,#012d82)] text-sm md:text-base sm:block hidden'>
                Book a meeting
            </button>

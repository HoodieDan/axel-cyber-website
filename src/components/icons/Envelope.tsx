type IEnvelopeProps = React.SVGProps<SVGSVGElement>;

const Envelope = ({ className, ...rest }: IEnvelopeProps) => {
    return (
        <svg
            width="20"
            height="20"
            ...
            {...rest}
        >
            <g clip-path="url(#clip0_5912_4051)">
                <path

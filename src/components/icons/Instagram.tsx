type IInstagramProps = React.SVGProps<SVGSVGElement>;

const Instagram = ({ className, ...rest }: IInstagramProps) => {
    return (
        <svg
            width="20"
            height="20"
            ...
            {...rest}
        >
            <g clip-path="url(#clip0_5912_4057)">
                <path

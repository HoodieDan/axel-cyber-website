    ...
    <section className='w-[90%] max-w-screen-xl mx-auto my-8 sm:my-10 md:my-12 lg:my-16 flex flex-col md:flex-row justify-between items-center gap-x-6 lg:gap-x-10 gap-y-8'>
        <div className='flex-1'>
            <motion.p
                ...
                className='flex flex-row gap-2 text-center md:text-left text-[#3084da] mb-3 text-2xl sm:text-3xl  md:text-4xl lg:text-5xl xl:text-6xl 3xl:text-4xl font-bold'
            >
            ...
            <motion.p
                ...
                className='flex gap-2 text-center md:text-left mb-3 md:mb-4 lg:mb-6 text-2xl sm:text-3xl  md:text-4xl lg:text-5xl xl:text-6xl 3xl:text-4xl font-bold text-black'
                >
            ...
            <motion.p
                ...
                className='text-center md:text-left mb-6 md:mb-8 lg:mb-10 text-base md:text-xl lg:text-2xl 3xl:text-xl font-normal text-black w-auto md:w-[90%]'>
            ...
            <motion.div
                ...
                <motion.button
                    ...
                    className='whitespace-nowrap py-3 lg:py-4 px-4 md:px-6 lg:px-8 3xl:px-4 text-white rounded-md text-base bg-[linear-gradient(45deg,#0146cc,#012d82)] hover:bg-[linear-gradient(45deg,#025aff,#0146cc)] cursor-pointer leading-none transition-all duration-300 ease-linear'>
                    Check our Case studies
                </motion.button>
                <motion.button
                    variants={itemsVariants}
                    onClick={() => handleNavigation("/contact")}
                    className='whitespace-nowrap py-3 lg:py-4 px-4 lg:px-6 3xl:px-3 text-black text-base border border-[#0081f1] rounded-md flex flex-row items-center justify-center gap-1 bg-[#edf1fa] hover:opacity-70 transition-all duration-300 ease-linear cursor-pointer leading-none'
                >
                    Discuss a Project 

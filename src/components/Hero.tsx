...
export default function Hero() {
  ...
  return (
    <section className='px-[5%] mx-auto mt-8 mb-12 sm:my-10 md:my-12 lg:my-16 flex flex-col md:flex-row justify-between items-center gap-x-4 lg:gap-x-8 gap-y-6'>

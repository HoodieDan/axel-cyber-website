        ...
        <div className="rounded-lg hover:shadow-lg active:shadow-lg transition-all duration-300 ease-linear">
            <div className="mb-2">
                <img
                    ...
                    className="w-full rounded-sm md:rounded-md lg:rounded-lg"
                    src={coverPic}
                />
            </div>
            <div className="relative">
                <Suspense fallback={<span className="w-5 h-5 inline-block animate-pulse bg-gray-300 rounded-full" />}>
                    <BsArrowUpRightCircleFill
                        ...
                        className="cursor-pointer text-[#032d74] absolute right-0 top-0 text-3xl"
                    />
                </Suspense>
                ...
                <div className="flex gap-4 pb-2 md:pb-3">
                    {topics.map((topic, index) => {
                        ...
                        return (
                            <p
                                className={`text-base md:text-xl py-1 px-4 rounded-full font-semibold`}
                                style={{ backgroundColor: colorArray[number].bg, color: colorArray[number].color }}
                                key={index}
                            >
                                {topic}
                            </p>

...
export default function Contact() {
  return (
    <main>
        ...
        <section className='px-[5%] my-8 sm:my-10 md:my-12 lg:my-16 flex flex-col md:flex-row  gap-6 sm:gap-8 md:gap-12 lg:gap-16'>
            ...
            <div className='rounded-xl flex-1 bg-[#f1f2f4] py-4 sm:py-6 md:py-8 lg:py-10 px-4 md:px-6 lg:px-8'>
                ...
                <form action="">
                    ...
                    <button className='bg-[linear-gradient(135deg,#002366,#0046cc)] p-4  rounded-md text-white'>Send a message</button>
                </form>
            </div>
        </section>
        <section className='px-[5%] my-8 sm:my-10 md:my-12 lg:my-16'>

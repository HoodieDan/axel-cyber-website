                ...
                <CarouselContent>
                    {Array.from({ length: 5 }).map((_, index) => (
                        <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3 md:pl-6">
                            <div className="p-1">
                                <Card className="bg-[url(/src/assets/customers-say-card-bg.png)] bg-cover bg-center rounded-2xl border-none shadow-none">
                                    <CardContent className="flex flex-col aspect-square justify-evenly">
                                        ...
                                        <div className="flex items-center gap-x-4">
                                            <img src={CardAvatar} alt="Card avatar" className="object-fill size-12.5" />

  ...
  return (
    <main>
        ...
        <section className='relative px-[5%] my-8 sm:my-10 md:my-12 lg:my-16'>
          ...
          <div className='hidden lg:block absolute top-0 left-[5%] bg-white w-[40%] rounded-br-2xl pr-2 xl:pr-4'>
            <p className='text-2xl xl:text-3xl font-semibold text-black mb-1 xl:mb-2 w-auto xl:w-[70%]'>
                We Bring The Future of AI To You With Our Expertise 
            </p>
            <p className='text-base xl:text-2xl font-normal text-black]'>
                Lexxa empowers every enterprose to build amazing products and capture true business value with AI language
            </p>
          </div>
          <div className='hidden lg:flex gap-4 xl:gap-6 absolute top-[7%] right-[7%]'>
            <div className='glassmorphism h-[100px] xl:h-[150px] w-[300px] xl:w-[450px] rounded-2xl'></div>
            <div className='h-[100px] xl:h-[150px] w-[100px] xl:w-[150px] bg-white rounded-2xl'></div>
          </div>
          <div className='absolute p-4 rounded-2xl bottom-[7%] left-[7%] bg-white w-[86%] lg:w-[47.7%] xl:w-[60%]'>
          ...
          <img style={{aspectRatio: "3/1.05"}} src={heroImg} alt="hero image" className='w-full' />
        </section>
        ...
        <section className='px-[5%] py-6 sm:py-8 md:py-10 lg:py-12'>
            ...
            <div className='flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16 xl:gap-20 items-center'>
                <div className='flex-1'>
                    <p className='text-2xl md:text-3xl lg:text-4xl xl:w-[70%] text-black font-semibold mb-2 md:mb-4 lg:mb-6'>
                ...
                <div className='self-stretch flex-1 flex flex-col gap-8'>
                    <div className='w-full relative pb-2 border-b border-black flex justify-center items-center'>
                        <p className='text-[#14388f] text-4xl absolute left-0 top-[50%] -translate-y-[50%]'>5+</p>
                        <p className='text-xl font-normal'>Countries worked in</p>
                    </div>
                    <div className='relative pb-2 border-b border-black flex justify-center items-center'>
                        <p className='text-[#14388f] text-4xl absolute left-0 top-[50%] -translate-y-[50%]'>12</p>
                        <p className='text-xl font-normal'>Years of experience</p>
                    </div>
                    <div className='relative pb-2 border-b border-black flex justify-center items-center'>
                        <p className='text-[#14388f] text-4xl absolute left-0 top-[50%] -translate-y-[50%]'>30</p>
                        <p className='text-xl font-normal'>Experienced team members</p>
                    </div>
                    <div className='relative pb-2 border-b border-black flex justify-center items-center'>
                        <p className='text-[#14388f] text-4xl absolute left-0 top-[50%] -translate-y-[50%]'>180+</p>
                        <p className='text-xl font-normal'>Clients worked for</p>
                    </div>
                    <div className='relative pb-2 border-b border-black flex justify-center items-center'>
                        <p className='text-[#14388f] text-4xl absolute left-0 top-[50%] -translate-y-[50%]'>5.1k+</p>
                        <p className='text-xl font-normal'>Screens completed</p>
                    </div>
                    <div className='relative pb-2 border-b border-black flex justify-center items-center'>
                        <p className='text-[#14388f] text-4xl absolute left-0 top-[50%] -translate-y-[50%]'>$31k+</p>
                        <p className='text-xl font-normal'>Screens completed</p>
                    </div>
                </div>
            </div>  

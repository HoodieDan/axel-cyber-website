  ...
  return (
    <main>
        <section className="px-[5%] bg-white py-6 sm:py-8 md:py-10 lg:py-12">
            <p className='text-2xl md:text-3xl font-semibold mb-4 md:mb-8 w-auto md:w-[300px] lg:w-[450px]'>Experience The Future of A Great Company with Our AI Tools</p>
            <div className='relative'>
                <img src={solutionImg} alt='solution image' />
                <p className='hidden md:block text-base md:text-xl absolute -bottom-2 left-[26.5%] md:w-[200px] lg:w-[325px]'>
        ...
        <section className="px-[5%] bg-white py-6 sm:py-8 md:py-10 lg:py-12 lg:pb-14">
            ...
            <p className='text-center text-2xl md:text-3xl font-semibold md:w-[350px] mx-auto mb-4 sm:mb-6 md:mb-8 lg:mb-10'>The best solutions for the best Companies</p>
